...
// In-memory admin users (use MongoDB in production)
const admins = [
  {
    id: 1,
    username: 'admin',
    email: 'admin@srmsolutions.com',
    password: '$2a$10$Gd.rOxJZ3qZ9uX5Y6Z7X8Oe9qV1w2E3R4T5Y6U7I8O9P0Q1R2S3T4U5' // bcrypt hash of 'admin123'
  }
];
...
router.get('/dashboard', authenticateToken, (req, res) => {
  res.json({
    ...
    data: {
      ...
      monthlyGrowth: 12,
      recentQuotes: [
        { id: 1, client: 'TechCorp', service: 'AI', amount: '₹1,20,000', date: '2025-09-01' }
      ],
      popularServices: [
